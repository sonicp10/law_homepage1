  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-[100] bg-[var(--primary)] flex items-stretch h-14 shadow-[0_-10px_30px_rgba(0,0,0,0.15)] pb-safe">
        <Link href="/qna/diagnosis" className="flex-1 flex flex-col items-center justify-center gap-0.5 border-r border-white/10 active:bg-white/10 transition-colors">
          <span className="text-lg">📊</span>
          <span className="text-[10px] font-bold text-white/90">1분 자가진단</span>
        </Link>
        <Link href="/qna/visit" className="flex-1 flex flex-col items-center justify-center gap-0.5 border-r border-white/10 active:bg-white/10 transition-colors">
          <span className="text-lg">📅</span>
          <span className="text-[10px] font-bold text-white/90">방문예약</span>
        </Link>
        <Link href="/qna/phone" className="flex-[1.2] flex flex-col items-center justify-center gap-0.5 bg-[var(--secondary)] active:brightness-90 transition-all text-white">
          <span className="text-lg">📞</span>
