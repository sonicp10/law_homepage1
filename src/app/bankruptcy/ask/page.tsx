    ...
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-[var(--primary)]/60 font-medium max-w-2xl mx-auto leading-relaxed">
          개인파산 신청부터 절차, 비용까지 가장 많이 궁금해하시는 50가지 질문에 대해 명쾌한 답을 드립니다.
        </p>
      </div>
      ...
      <div className="relative mb-12 group">
        ...
        <input
          type="text"
          placeholder="궁금한 키워드를 입력해보세요 (예: 면책, 비용, 파산관재인...)"
          value={searchQuery}
      ...
      <div className="mt-24 p-12 bg-[var(--primary)] rounded-[var(--radius-card)] text-white text-center shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 mb-10 max-w-2xl mx-auto font-medium">
            개인파산은 채무자의 상황에 따라 최적의 전략이 다릅니다.<br />
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/s_story/bankruptcy" className="px-10 py-5 bg-white/10 text-white font-black rounded-full border border-white/20 hover:bg-white/20 transition-all flex items-center justify-center gap-2">
              성공 사례 보기
            </Link>
          </div>
        </div>
